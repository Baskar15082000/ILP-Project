...
const csvFilePath = "src/data/matches.csv"; // Replace with the actual path to your CSV file
const jsonFilePath = "matches.json"; // Replace with the desired path to save the JSON file
